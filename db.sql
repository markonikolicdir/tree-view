...
CREATE TABLE `tree_entry` (
  ...
  CONSTRAINT `SelfKey` FOREIGN KEY (`parent_entry_id`) REFERENCES `biological classification` (`entry_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `tree_entry_lang` (
  ...
  CONSTRAINT `tree_entry` FOREIGN KEY (`entry_id`) REFERENCES `tree_entry` (`entry_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  INDEX (`entry_id`)
